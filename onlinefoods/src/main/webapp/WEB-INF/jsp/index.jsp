    ...
    <c:forEach items="${listsanpham}" var="t">
        <div class="col-md-3 col-xs-12" style="margin-top: 25px" >
            <div class="card" style="width:300px;min-height: 400px;border: 0.3rem solid #e1f7f7;">
                <img class="card-img-top" src="${t.anh}" alt="Card image" style="min-height: 240px" >
                <div class="card-body" >
                    ...
                    <a href="<c:url value="/sanpham/${t.id}" />" class="btn btn-outline-info" style="margin-left: 75px">Xem Chi Tiết</a>
                </div>
            </div>
        </div>
    </c:forEach>
