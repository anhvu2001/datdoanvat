...
<form:form method="post" action="${action}"  modelAttribute="sanpham" enctype="multipart/form-data"  >
    <div class="form-floating mb-3 mt-3">
        <form:input type="text" path="tensanpham" class="form-control" id="name" placeholder="name" name="name" />
        <label for="name">Tên sản phẩm</label>
    </div>
    <div style="margin-bottom: 15px" >
        <label for="name">Giá sản phẩm(VND)</label>
        <form:input type="number" path="giaSp" class="form-control" id="giasp" />
    </div>
    <div style="margin-bottom: 15px" >
        <label for="name">Khối lượng(Gam)</label>
        <form:input type="number" path="khoiluong" class="form-control"   />
    </div>
    <div class="form-floating mb-3 mt-3">
        <form:input type="textarea" path="mota" class="form-control" id="name" placeholder="name" name="name" />
